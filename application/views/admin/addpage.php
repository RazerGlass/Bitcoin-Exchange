	...
	<form role="form" method="post" action="<?php echo ADMINURL; ?>/insertpage">
	...
	<div class="form-group">
		<div class="col-sm-10">
		<input name="purl" type="text" class="form-control" id="field-1" placeholder="<?php _ex("Enter a Page URL"); ?>">
					</div>
					</div>
					</div>
				...
				<button class="btn btn-blue btn-icon pull-right"><?php _ex("Add page"); ?></button>
				</div></div>
