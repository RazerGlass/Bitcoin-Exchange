	...
	<form role="form" method="post" action="<?php echo ADMINURL; ?>/insertguide">
	<div class="form-group">
				<div class="col-sm-10">
		<input name="title" type="text" class="form-control" id="field-1" placeholder="<?php _ex("Enter a Title for user guide"); ?>">
					</div>	
		<div class="col-sm-10">
		<input name="url" type="text" class="form-control" id="field-1" placeholder="<?php _ex("Enter a url for user guide"); ?>">
					</div>
					</div>
					</div>
				...
				<button class="btn btn-blue btn-icon pull-right"><?php _ex("Add User Guide"); ?></button>
				</div>
				</div>
